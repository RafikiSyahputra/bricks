...
if (isset($_POST["updateUser"])) {
  if (updateUser($_POST) > 0) {
    ...
    echo "<script>
            alert('Gagal Diubah, Coba Lagi Ya');
            document.location.href = '?page=profile';
          </script>";
  }
}
      ...
      <ul class="navbar-nav d-none d-lg-flex ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a href="../index.php" class="dropdown-item">Kembali Ke Beranda</a>
...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    ...
    <div class="dashboard-heading">
        ...
        <p class="dashboard-subtitle">Apakah Kamu Ingin Mengubah Profil?</p>
    </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row mt-2">
                          ...
                          <button type="submit" name="updateUser" class="btn btn-dark px-4">Simpan</button>
                          </div>
                      </div>
                  </div>
              </form>
