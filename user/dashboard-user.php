...
>
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">Menu Profil</p>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card mb-2">
            ...
            ?>
              <div class="dashboard-card-title">Jumlah Transaksi Kamu</div>
        ...
        <div class="col-md-6">
          <div class="card mb-2">
            ...
            ?>
              <div class="dashboard-card-title">Total Transaksi Kamu</div>
