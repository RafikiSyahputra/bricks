...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">Kelola Kategori Produk</p>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-12">
                <a href="?page=categories-create" class="btn btn-dark">
                            ...
                            <td style="width: 20%;">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" onclick="return confirm('Apakah Ingin Menghapus category Ini ?')" href="?page=categories-delete&id=<?= $category["id"]; ?>">Hapus</button>
                                </div>
                              </div>
                            </td>
                          </tr>
