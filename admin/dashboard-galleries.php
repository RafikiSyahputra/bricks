...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">Kelola Galeri Produk</p>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-12">
                <a href="?page=galleries-create" class="btn btn-dark">
                  + Tambah Galeri Baru
                </a>
                </div>
              </div>
                            ...
                            <td style="width: 20%;">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" onclick="return confirm('Apakah Ingin Menghapus Gallery Ini ?')" href="?page=galleries-delete&id=<?= $gallery["id_gallery"]; ?>">Hapus</button>
                                </div>
                              </div>
                            </td>
                          </tr>
