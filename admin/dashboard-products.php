...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">Kelola Dengan Baik Ya!</p>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-12">
                <a href="?page=products-create" class="btn btn-dark">
                          ...
                          <tr>
                            ...
                            <td>
                              <?php if ($product["stock"] <= 0) : ?>
                                <span class="badge badge-pill badge-danger">Terjual</span>
                              <?php else: ?>
                            ...
                            <td style="width: 17%; text-align: center;">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" onclick="return confirm('Apakah Ingin Menghapus <?= $product['product_name'] ?> ?')" href="?page=products-delete&id=<?= $product["id_product"]; ?>">Hapus</a>
                                </div>
                              </div>
                            </td>
                          </tr>
