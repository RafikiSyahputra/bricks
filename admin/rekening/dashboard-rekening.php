...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">Kelola Rekening</p>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-12">
                <a href="?page=rekening-create" class="btn btn-dark">
                            ...
                            <td style="width: 17%; text-align: center;">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <a class="dropdown-item" href="?page=rekening-details&id=<?= $rekening["id_rekening"]; ?>">Update</a>
                                  <a class="dropdown-item" onclick="return confirm('Apakah Ingin Menghapus <?= $rekening['bank_name'] ?> ?')" href="?page=rekening-delete&id=<?= $rekening["id_rekening"]; ?>">Hapus</a>
                                </div>
                              </div>
                            </td>
                          </tr>
