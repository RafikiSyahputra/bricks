            ...
            <div class="row">
              ...
              <?php if (!isset($_SESSION["login"]) && !isset($_SESSION["user"])) : ?>
                <div class="col-lg-2" data-aos="zoom-in">
                  <a href="login.php" class="btn btn-dark px-4 text-white btn-block mb-3 py-2">
              ...
              <?php else : ?>
                <div class="col-lg-2" data-aos="zoom-in">
                  ...
                  <button type="submit" name="addToCart" class="btn btn-dark px-4 text-white btn-block mb-3 py-2">
                    Masukkan Ke Keranjang
                  </button>
                </div>
              <?php endif; ?>
